...
SECRET_KEY = 'django-insecure-es)y7=nw@c@gxd!*x+-=-@ht_#1_0i=6%czy6g0df@2*&c67y^'
...
# https://docs.djangoproject.com/en/5.2/topics/media/
MEDIA_URL = '/media/'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'travelbuddy411@gmail.com'
EMAIL_HOST_PASSWORD = 'qdizuxszcudzccwn'
